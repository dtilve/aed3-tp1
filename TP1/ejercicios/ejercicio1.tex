...
\par{Decidimos que los subproblemas deben tener igual complejidad porque para medirlos con el teorema maestro, una hipotesis es que tienen igual complejidad.}
