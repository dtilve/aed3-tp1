...
\begin{algorithmic}[1]
  \Procedure{$i$InicializarMatriz}{\In{filas}{int}, \In{columnas}{int}, \Inout{matriz}{int} }
	\State For{h} (int h = 0; h < filas; h++)
		for (int q = 0; q < columnas; q++){ \Comment $\mathcal{O}(columnas)$
			matriz[h][q] = 0;
		}
	}
}
