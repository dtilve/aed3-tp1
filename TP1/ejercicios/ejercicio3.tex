...
\paragraph{Para determinar la cota de complejidad planteamos el $\acute{a}$rbol de llamadas recursivas para una entrada de n enemigos. Para armar este arbol no tuvimos en cuenta las podas.}
\paragraph{En la primera llamada a Kamehameha se obtienen n $\acute{a}$rboles iteraci$\acute{o}$}
