...
void destruir(int, int, vector<tuple<int,int>>, int, int);

int genkidamasUtilizadas;
int indiceDeObjetivoPorArea;
...
void genkidama(int t, int n, vector<tuple<int,int>> e){
	...
	vector<int> atacados;
	genkidamasUtilizadas = 0;
	indiceDeObjetivoPorArea = n-1;
